# Contributing to LlamaGo Finsim

Thank you for your interest in contributing to LlamaGo Finsim! This document provides guidelines and instructions for contributing to this project.
...
There are many ways to contribute to LlamaGo Finsim:
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/YOUR_USERNAME/llamago-finsim.git
   cd llamago-finsim
   ```

3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/llamago-finsim.git
   ```
...
By contributing to LlamaGo Finsim, you agree that your contributions will be licensed under the project's MIT License.
