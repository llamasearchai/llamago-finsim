"""
Client module for llamago-finsim.
"""
...
class Client:
    """Main client for interacting with the llamago-finsim API."""
    ...
    def __init__(self, api_key=None, base_url=None, config=None):
        ...
        self.base_url = base_url or "https://api.llamasearch.ai/llamago-finsim"
